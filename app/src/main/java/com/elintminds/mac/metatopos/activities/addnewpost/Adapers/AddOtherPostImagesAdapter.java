...
public class AddOtherPostImagesAdapter extends RecyclerView.Adapter<AddOtherPostImagesAdapter.PostImagesViewHolder> {
    Context context;
    ...
    public AddOtherPostImagesAdapter(Context context, ArrayList<String> fileUploadData) {
