...
public class AdvertisementAdapter extends RecyclerView.Adapter<AdvertisementAdapter.OfferHolder> {
    Context context;
    ArrayList<Integer> data;
    List<GetPostByIdRecentComment> comments;

    public AdvertisementAdapter(Context context, List<GetPostByIdRecentComment> comments) {
