...
import com.elintminds.mac.metatopos.adapters.FeaturedGenMojiAdapter;
...
public class FeaturedGenMojifragmentviewClass extends Fragment implements AdapterClickListerner {

    APIService mapiService;
    //    ArrayList<GenEmojiData> genEmojiData;
    FeaturedGenMojiAdapter adapter;
    RecyclerView genMoji_Rview;
    GridLayoutManager gridLayoutManager;
    List<GenEmojiData> emojidata;
    GenMojiActivity parentActivity;

    public FeaturedGenMojifragmentviewClass() {
    }
    ...
    void getGenEmoji() {
        if (AppUtils.isInternetIsAvailable(getContext())) {
            ...
            Call<GemEmojiResponse> call = mapiService.FeaturedGenmojiRespose();
                ...
                public void onResponse(Call<GemEmojiResponse> call, Response<GemEmojiResponse> response) {
                    if (response.isSuccessful()) {
                        if (response.body().getStatus() == true) {
                            ...
                            adapter = new FeaturedGenMojiAdapter(getContext(), emojidata, FeaturedGenMojifragmentviewClass.this);
