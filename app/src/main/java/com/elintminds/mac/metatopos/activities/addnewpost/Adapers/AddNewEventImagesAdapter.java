...
public class AddNewEventImagesAdapter extends RecyclerView.Adapter<AddNewEventImagesAdapter.PostImagesViewHolder> {
    Context context;
    ...
    public AddNewEventImagesAdapter(Context context, ArrayList<String> fileUploadData) {
