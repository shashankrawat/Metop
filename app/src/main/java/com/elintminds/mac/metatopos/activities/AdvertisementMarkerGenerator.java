...
public class AdvertisementMarkerGenerator {
    ...
    public AdvertisementMarkerGenerator(Context context) {
        this.mContext = context;
        this.mBackground = new BubbleMarker(this.mContext.getResources());
        this.mContainer = (ViewGroup) LayoutInflater.from(this.mContext).inflate(R.layout.advertisement_mrker_layout, (ViewGroup) null);
//        this.mRotationLayout = (RotationLayout) this.mContainer.getChildAt(0);
        this.mContentView = this.title = (TextView) this.mContainer.findViewById(R.id.advertisement_description);
        this.mContentView = this.viewcount = (TextView) this.mContainer.findViewById(R.id.viewcount);
        this.mContentView = this.profileimage = this.mContainer.findViewById(R.id.profileimage);
...
//        }
    ...
    public View setAdsMarkerDetails(MarkerInfo markerInfo) {
