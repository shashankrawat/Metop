...
public class AddNewSportsImagesAdapter extends RecyclerView.Adapter<AddNewSportsImagesAdapter.PostImagesViewHolder> {
    Context context;
...
//    ArrayList<Attachments> attachmentsList;

    public AddNewSportsImagesAdapter(Context context, ArrayList<String> fileUploadData) {
