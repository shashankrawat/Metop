...
public class AdvertismentIconMaker {
    ...
    public AdvertismentIconMaker(Context context) {
        this.mContext = context;
        this.mBackground = new BubbleMarker(this.mContext.getResources());
        this.mContainer = (ViewGroup)LayoutInflater.from(this.mContext).inflate(layout.amu_text_bubble, (ViewGroup)null);
        this.mRotationLayout = (RotationLayout)this.mContainer.getChildAt(0);
        this.mContentView = this.mTextView = (TextView)this.mRotationLayout.findViewById(id.amu_text);
        this.setStyle(1);
    }
    ...
    public void setContentView(View contentView) {
        ...
        View view = this.mRotationLayout.findViewById(id.amu_text);
