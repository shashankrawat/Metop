...
public class AddNewServicesImagesAdapter extends RecyclerView.Adapter<AddNewServicesImagesAdapter.PostImagesViewHolder> {
    Context context;
    ...
    public AddNewServicesImagesAdapter(Context context, ArrayList<String> fileUploadData) {
