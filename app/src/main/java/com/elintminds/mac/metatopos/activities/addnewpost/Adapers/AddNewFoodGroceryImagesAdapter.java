...
public class AddNewFoodGroceryImagesAdapter extends RecyclerView.Adapter<AddNewFoodGroceryImagesAdapter.PostImagesViewHolder> {
    Context context;
    ...
    public AddNewFoodGroceryImagesAdapter(Context context, ArrayList<String> fileUploadData) {
