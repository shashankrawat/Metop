...
public class AdvertisementImagesSliderAdapter extends PagerAdapter {
    private Context context;
    List<AdvertisementAttachment> attachments;

    public AdvertisementImagesSliderAdapter(Context context, List<AdvertisementAttachment> attachments) {
