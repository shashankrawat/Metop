...
public class GetPostByIdLoggedUserInfo implements Parcelable {
        ...
        public Integer getAverageStarRating() {
            return averageStarRating;
        }

        public void setAverageStarRating(Integer averageStarRating) {
        ...
        public String getIsAlreadyFollowed() {
            return isAlreadyFollowed;
        }

        public void setIsAlreadyFollowed(String isAlreadyFollowed) {
    ...
    protected GetPostByIdLoggedUserInfo(Parcel in) {
    }

    public static final Creator<GetPostByIdLoggedUserInfo> CREATOR = new Creator<GetPostByIdLoggedUserInfo>() {
        @Override
        public GetPostByIdLoggedUserInfo createFromParcel(Parcel in) {
            return new GetPostByIdLoggedUserInfo(in);
        }

        @Override
        public GetPostByIdLoggedUserInfo[] newArray(int size) {
            return new GetPostByIdLoggedUserInfo[size];
        }
    };
