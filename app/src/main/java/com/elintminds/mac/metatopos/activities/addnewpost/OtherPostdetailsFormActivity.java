...
import com.elintminds.mac.metatopos.activities.addnewpost.Adapers.AddOtherPostImagesAdapter;
...
public class OtherPostdetailsFormActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    AddOtherPostImagesAdapter addOtherPostImagesAdapter;
    ArrayList<Integer> data = new ArrayList<>(Arrays.asList(R.drawable.ic_genmoji_man, R.drawable.ic_genmoji_woman, R.drawable.ic_genmoji_man, R.drawable.ic_genmoji_woman, R.drawable.ic_genmoji_man));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_othe_postdetails_form);
        ...
        addOtherPostImagesAdapter = new AddOtherPostImagesAdapter(getApplicationContext(), fileUploadData);
        post_ImagesContainer_recyclrview.setAdapter(addOtherPostImagesAdapter);
        ...
        if (isFrom.equals("OtherProfile")) {
            ...
            addOtherPostImagesAdapter.notifyDataSetChanged();
        ...
        } else if (isFrom.equals("Category_Other")) {
            ed_Name.setText("");
            ed_Price.setText("");
    ...
    private void initviews() {
        icon_back = findViewById(R.id.other_post_backbtn);
        ed_Name = findViewById(R.id.otherpost_name);
        ed_Price = findViewById(R.id.otherpost_price);
        ed_Description = findViewById(R.id.otherpost_description);
        ed_Time = findViewById(R.id.otherpost_time);
        ed_Location = findViewById(R.id.otherpost_location);
        upload_PostImages = findViewById(R.id.upload_otherpost_images);
        post_ImagesContainer_recyclrview = findViewById(R.id.otherpost_images_container_rv);
        visibilty_Type = findViewById(R.id.otherpost_visibility);
        visible_Everyone = findViewById(R.id.otherpost_visibility_everyone);
        visible_FollowersOnly = findViewById(R.id.otherpost_visibility_followersonly);
        tv_location_address = findViewById(R.id.tv_location_address);
        btn_Post = findViewById(R.id.otherpost_btn);
...
//            mTimePicker.show();
            ...
            if (ContextCompat.checkSelfPermission(OtherPostdetailsFormActivity.this,
            ...
            if (ed_Name.getText().toString().trim().equals("")) {
            ...
            } else if (addOtherPostImagesAdapter.getItemCount() == 0) {
                Toast.makeText(this, R.string.upload_atleast_one_image, Toast.LENGTH_SHORT).show();
            } else {
                if (isFrom.equals("Category_Other")) {
                    map.put("categoryId", "");
                    map.put("postid", "");
                ...
                } else if (isFrom.equals("OtherProfile")) {
                    map.put("categoryId", "");
                    map.put("postid", "");
    ...
    private void requestStoragePermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(this,
            ...
            ActivityCompat.requestPermissions(OtherPostdetailsFormActivity.this,
        ...
        if (AppUtils.isInternetIsAvailable(getApplicationContext())) {
            ...
            call.enqueue(new Callback<FileupoladResponse>() {
                ...
                public void onResponse(Call<FileupoladResponse> call, Response<FileupoladResponse> response) {
                    if (response.isSuccessful()) {
                        if (response.body().getStatus() == true) {
                            Toast.makeText(OtherPostdetailsFormActivity.this, R.string.image_uploaded, Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(OtherPostdetailsFormActivity.this, response.message(), Toast.LENGTH_SHORT).show();
                            m_Dialog.dismiss();
                        }
                    }
                }
                ...
                public void onFailure(Call<FileupoladResponse> call, Throwable t) {
                    ...
                    Toast.makeText(OtherPostdetailsFormActivity.this, "Failed " + t.getMessage(), Toast.LENGTH_LONG).show();
                    m_Dialog.dismiss();
                }
            });
        } else {
        ...
        if (AppUtils.isInternetIsAvailable(getApplicationContext())) {
            ...
            call.enqueue(new Callback<SavePostResponse>() {
                ...
                public void onResponse(Call<SavePostResponse> call, Response<SavePostResponse> response) {
                    if (response.isSuccessful()) {
                        if (response.body().getStatus() == true) {
                            Toast.makeText(OtherPostdetailsFormActivity.this, "" + response.body().getMessage(), Toast.LENGTH_SHORT).show();
                            m_Dialog.dismiss();
                            finish();
