...
public class AddNewAdvertisementImagesAdapter extends RecyclerView.Adapter<AddNewAdvertisementImagesAdapter.PostImagesViewHolder> {
    Context context;
    ...
    public AddNewAdvertisementImagesAdapter(Context context, ArrayList<String> fileUploadData) {
