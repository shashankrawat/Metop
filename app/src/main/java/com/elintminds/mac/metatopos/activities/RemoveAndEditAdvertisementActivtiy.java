...
public class RemoveAndEditAdvertisementActivtiy extends AppCompatActivity implements View.OnClickListener {
    ...
    TextView userName, postTime, totalViews, totalComment, totalReviews, postTitle, postDescription, postAddress, tv_send_comment, tv_distance;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_remove_and_edit_advertisement_activtiy);
...
//            startActivity(i);
            ...
            if (postType.equals("advertisement")) {
                Intent i = new Intent(this, AdvertisementDetailsFormActivity.class);
                i.putExtra("Edit_Post_Data", postdata.get(0));
                i.putExtra("isFromRemoveEditActivity", "Advertisements");
                startActivity(i);
            }
...
//                        recyclerView.setAdapter(postCommentAdapter);
    ...
    private void displayUserData() {
        ...
        Log.e("Description", "" + postdata.get(0).getDescription());
    ...
    private void imageslider() {
        mPager.setAdapter(new PostImagesSliderAdapter(RemoveAndEditAdvertisementActivtiy.this, attachments));
        ...
        if (AppUtils.isInternetIsAvailable(getApplicationContext())) {
            ...
            call.enqueue(new Callback<RemovePostResponse>() {
                ...
                public void onResponse(Call<RemovePostResponse> call, Response<RemovePostResponse> response) {
                    if (response.isSuccessful()) {
                        if (response.body().getStatus() == true) {
                            Toast.makeText(RemoveAndEditAdvertisementActivtiy.this, "" + response.body().getMessage(), Toast.LENGTH_SHORT).show();
                            m_Dialog.dismiss();
                            finish();
                        } else {
                            Toast.makeText(getApplicationContext(), "" + response.body().getMessage(), Toast.LENGTH_SHORT).show();
