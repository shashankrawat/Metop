...
import com.elintminds.mac.metatopos.activities.addnewpost.Adapers.AddNewSportsImagesAdapter;
...
public class SportsEntertainmentDetailsFormActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    AddNewSportsImagesAdapter addNewSportsImagesAdapter;
    ...
    String categoryID, filepath, SuperCategoryID, SubCategoryID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sports_entertainment_details_form);
        initviews();
        ...
        addNewSportsImagesAdapter = new AddNewSportsImagesAdapter(getApplicationContext(), fileUploadData);
        post_ImagesContainer_recyclrview.setAdapter(addNewSportsImagesAdapter);
        ...
        if (isFrom.equals("SportsEntertainment")) {
            ...
            addNewSportsImagesAdapter.notifyDataSetChanged();

        } else if (isFrom.equals("Category_Sports")) {
            ed_Name.setText("");
            ed_Price.setText("");
    ...
    private void initviews() {
        icon_back = findViewById(R.id.sports_backbtn);
        ed_Name = findViewById(R.id.sports_name);
        ed_Price = findViewById(R.id.sports_price);
        ed_Description = findViewById(R.id.sports_description);
        ed_Time = findViewById(R.id.sports_time_duration);
        ed_Location = findViewById(R.id.sports_lacation);
        upload_PostImages = findViewById(R.id.upload_sports_image);
        post_ImagesContainer_recyclrview = findViewById(R.id.sports_images_container_rv);
        visibilty_Type = findViewById(R.id.sports_visibility_type);
        visible_Everyone = findViewById(R.id.sports_visibility_everyone);
        visible_FollowersOnly = findViewById(R.id.sports_visibility_followers);
        btn_Post = findViewById(R.id.sports_post_btn);
...
//            mTimePicker.show();
            ...
            if (ContextCompat.checkSelfPermission(SportsEntertainmentDetailsFormActivity.this,
            ...
            if (ed_Name.getText().toString().trim().equals("")) {
            ...
            } else if (addNewSportsImagesAdapter.getItemCount() == 0) {
                Toast.makeText(this, R.string.upload_atleast_one_image, Toast.LENGTH_SHORT).show();

            } else {
                if (isFrom.equals("Category_Sports")) {
                ...
                } else if (isFrom.equals("SportsEntertainment")) {
...
//            mTimePicker.show();
    ...
    private void requestStoragePermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(this,
            ...
            ActivityCompat.requestPermissions(SportsEntertainmentDetailsFormActivity.this,
        ...
        if (AppUtils.isInternetIsAvailable(getApplicationContext())) {
            ...
            call.enqueue(new Callback<FileupoladResponse>() {
                ...
                public void onResponse(Call<FileupoladResponse> call, Response<FileupoladResponse> response) {
                    if (response.isSuccessful()) {
                        if (response.body().getStatus() == true) {
                            Toast.makeText(SportsEntertainmentDetailsFormActivity.this, R.string.image_uploaded, Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(SportsEntertainmentDetailsFormActivity.this, response.message(), Toast.LENGTH_SHORT).show();
                            m_Dialog.dismiss();
                        }
                    }
                }
                ...
                public void onFailure(Call<FileupoladResponse> call, Throwable t) {
                    ...
                    Toast.makeText(SportsEntertainmentDetailsFormActivity.this, "Failed " + t.getMessage(), Toast.LENGTH_LONG).show();
                    m_Dialog.dismiss();
                }
            });
        } else {
        ...
        if (AppUtils.isInternetIsAvailable(getApplicationContext())) {
            ...
            call.enqueue(new Callback<SavePostResponse>() {
                ...
                public void onResponse(Call<SavePostResponse> call, Response<SavePostResponse> response) {
                    if (response.isSuccessful()) {
                        if (response.body().getStatus() == true) {
                            Toast.makeText(SportsEntertainmentDetailsFormActivity.this, "" + response.body().getMessage(), Toast.LENGTH_SHORT).show();
                            m_Dialog.dismiss();
                            finish();
